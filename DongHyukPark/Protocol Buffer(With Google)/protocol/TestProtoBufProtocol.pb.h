...
#ifndef GOOGLE_PROTOBUF_INCLUDED_TestProtoBufProtocol_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_TestProtoBufProtocol_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_TestProtoBufProtocol_2eproto
...
struct TableStruct_TestProtoBufProtocol_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_TestProtoBufProtocol_2eproto;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::TestProtoBufProtocol::CS_LOGIN_REQ* Arena::CreateMaybeMessage<::TestProtoBufProtocol::CS_LOGIN_REQ>(Arena*);
template<> ::TestProtoBufProtocol::SC_LOING_RES* Arena::CreateMaybeMessage<::TestProtoBufProtocol::SC_LOING_RES>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace TestProtoBufProtocol {
...
class CS_LOGIN_REQ final :
    public ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase /* @@protoc_insertion_point(class_definition:TestProtoBufProtocol.CS_LOGIN_REQ) */ {
 public:
  ...
  inline void CopyFrom(const CS_LOGIN_REQ& from) {
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "TestProtoBufProtocol.CS_LOGIN_REQ";
  }
  protected:
  ...
  // @@protoc_insertion_point(class_scope:TestProtoBufProtocol.CS_LOGIN_REQ)
 private:
  class _Internal;
  ...
  friend struct ::TableStruct_TestProtoBufProtocol_2eproto;
};
// -------------------------------------------------------------------

class SC_LOING_RES final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:TestProtoBufProtocol.SC_LOING_RES) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "TestProtoBufProtocol.SC_LOING_RES";
  }
  protected:
  ...
  // @@protoc_insertion_point(class_scope:TestProtoBufProtocol.SC_LOING_RES)
 private:
  class _Internal;
...
inline ::PROTOBUF_NAMESPACE_ID::uint64 SC_LOING_RES::sessionindex() const {
  // @@protoc_insertion_point(field_get:TestProtoBufProtocol.SC_LOING_RES.sessionIndex)
...
inline void SC_LOING_RES::set_sessionindex(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  ...
  // @@protoc_insertion_point(field_set:TestProtoBufProtocol.SC_LOING_RES.sessionIndex)
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_TestProtoBufProtocol_2eproto
