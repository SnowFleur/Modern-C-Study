...
$peerConnectionOptions = "{ \""iceServers\"": [{\""urls\"": [\""stun:stun1.1.google.com:19302\"",\""turn:172.30.1.17:19303\""], \""username\"": \""PixelStreamingUser\"", \""credential\"": \""AnotherTURNintheroad\""}] }"
